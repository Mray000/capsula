    ...
    <TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
      <KeyboardAvoidingView
        ...
        <View style={styles.container}>
          ...
          <Text allowFontScaling={false} style={styles.sub_auth_title}>
            Авторизация возможна для активных клиентов CAPSULA by Osipov. Если
            вы новый клиент, создайте свою первую запись в главном разделе. Так
            вы зарегистрируетесь в системе YCLIENTS
          </Text>
