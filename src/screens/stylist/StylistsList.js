    ...
    return (
        <View style={{flex: 1}}>
            <View style={{
                ...
                {!is_global ? (
                    <View style={{backgroundColor: '#FCFCFC', marginBottom: verticalScale(10), paddingHorizontal: 10}}>
                        <TouchableOpacity
                            onPress={() => {
                                dispatch(setStylist({
                                    id: 0,
                ...
                <View style={{flex: 1, backgroundColor: '#FCFCFC', paddingTop: verticalScale(10)}}>
                    <FlatList
