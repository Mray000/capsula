  ...
  return (
    <View
      ...
      {codeArray?.map((code, index) => {
        ...
        const viewBackgroundColor = codeViewBackgroundColor
        ...
        const viewBorderRadius = codeViewBorderRadius
          ...
          : {};
        const viewBorderColor = codeViewBorderColor
        ...
        const box_shadow = code ? styles.box_shadow_1 : styles.box_shadow_2;
