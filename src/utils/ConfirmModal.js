      ...
      <View style={styles.centered_view}>
        <View style={styles.modal_view}>
          ...
          <View style={styles.buttons_container}>
            <TouchableOpacity
              style={[styles.button_container, styles.right_border]}
              onPress={onPressConfirm}>
              <Text allowFontScaling={false} style={styles.confirm_button}>
                {confirmText}
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
              ...
              <Text allowFontScaling={false} style={styles.cancel_button}>
                {cancelText}
              </Text>
            </TouchableOpacity>
          </View>
